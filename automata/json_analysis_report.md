...
**扫描目录**: `/Users/pengqianhan/Documents/GitHub/Dainarx-pq/automata`
...
- ✓ `FaMoS/two_state_ha.json` (共 2 个mode): `x1[0]`, `x1[1]`
...
- ✗ `FaMoS/three_state_ha.json` (共 3 个mode)
...
- ✗ `linear/two_tank.json` (共 2 个mode)
